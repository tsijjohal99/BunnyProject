...
class Bunny {
   private:
    ...
    std::string name;
    bool infected;
    inline static std::vector<std::string> maleBunnyNames{"Liam",
                                                          "Noah",
                                                          "Oliver",
                                                          "Elijah",
                                                          "William",
    ...
    inline static std::vector<std::string> femaleBunnyNames{"Olivia",
                                                            "Emma",
                                                            "Ava",
                                                            "Charlotte",
                                                            "Sophia",
   ...
   public:
    ...
    explicit Bunny(std::pair<int, int> loc, int old);
